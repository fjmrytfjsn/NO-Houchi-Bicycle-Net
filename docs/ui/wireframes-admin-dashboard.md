...
2. 回収依頼候補
   - 役割: `reported` のまま 24 時間以上経過した案件を回収依頼候補として確認する画面
...
flowchart LR
  ...
  A --> C["回収依頼候補<br>reported の24時間超過案件を確認"]
...
- 回収依頼候補は、`reported` のまま 24 時間以上経過した案件から回収依頼に進める対象の確認に集中する。
