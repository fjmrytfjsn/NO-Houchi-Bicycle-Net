...
- Supporter/reporting flow: abandoned bicycle information is recorded through the backend report registration API, reverse geocoded through Google Maps when configured, and persisted in backend data models.
